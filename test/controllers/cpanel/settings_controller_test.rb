...
class Cpanel::SettingsControllerTest < ActionController::TestCase
  ...
  test "should create cpanel_setting" do
    assert_difference('Cpanel::Setting.count') do
      post :create, cpanel_setting: { description: @cpanel_setting.description, name: @cpanel_setting.name, value: @cpanel_setting.value }
    end
  ...
  test "should update cpanel_setting" do
    patch :update, id: @cpanel_setting, cpanel_setting: { description: @cpanel_setting.description, name: @cpanel_setting.name, value: @cpanel_setting.value }
    assert_redirected_to cpanel_setting_path(assigns(:cpanel_setting))
  end
